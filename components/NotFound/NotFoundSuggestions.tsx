        ...
        <section className="py-20 px-6 bg-hemp">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <TransitionLink href="/#stash" className="group p-8 bg-white border border-primary/5 shadow-sm hover:shadow-xl transition-all duration-300 text-center flex flex-col items-center">
                    ...
                    <TransitionLink href="/legend" className="group p-8 bg-white border border-primary/5 shadow-sm hover:shadow-xl transition-all duration-300 text-center flex flex-col items-center">
                    ...
                    <TransitionLink href="/study" className="group p-8 bg-white border border-primary/5 shadow-sm hover:shadow-xl transition-all duration-300 text-center flex flex-col items-center">
